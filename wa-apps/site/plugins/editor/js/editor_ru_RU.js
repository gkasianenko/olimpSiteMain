...
(function() {
  ...
  ContentEdit.Node = (function() {
    ...
    Node.fromDOMElement = function(domElement) {
      throw new Error('`fromDOMElement` не реализован');
    };
...
(function() {
  ...
  ContentTools.ImageDialog = (function(_super) {
    ...
    function ImageDialog() {
      ImageDialog.__super__.constructor.call(this, 'Добавление изображения');
    ...
    ImageDialog.prototype.mount = function() {
      ...
      this._domRotateCCW.setAttribute('data-ct-tooltip', ContentEdit._('Повернуть') + ' -90°');
      ...
      this._domRotateCW.setAttribute('data-ct-tooltip', ContentEdit._('Повернут') + ' 90°');
      ...
      this._domCrop.setAttribute('data-ct-tooltip', ContentEdit._('Вырезать'));
      ...
      this._domUpload.textContent = ContentEdit._('Загрузить');
  ...
  ContentTools.LinkDialog = (function(_super) {
    ...
    LinkDialog.prototype.mount = function() {
      ...
      this._domInput.setAttribute('placeholder', ContentEdit._('Вставте ссылку') + '...');
  ...
  ContentTools.PropertiesDialog = (function(_super) {
    ...
    function PropertiesDialog(element) {
      var _ref;
      this.element = element;
      PropertiesDialog.__super__.constructor.call(this, 'Свойства');
      this._attributeUIs = [];
    ...
    PropertiesDialog.prototype.mount = function() {
      ...
      this._domStyles.setAttribute('data-ct-empty', ContentEdit._('Для этого тега нет доступных стилей'));
      ...
      this._domStylesTab.setAttribute('data-ct-tooltip', ContentEdit._('Стили'));
      ...
      this._domAttributesTab.setAttribute('data-ct-tooltip', ContentEdit._('Атрибуты'));
      ...
      this._domCodeTab.setAttribute('data-ct-tooltip', ContentEdit._('Код'));
      ...
      this._domRemoveAttribute.setAttribute('data-ct-tooltip', ContentEdit._('Удалить'));
      ...
      this._domApply.textContent = ContentEdit._('Готово');
  ...
  AttributeUI = (function(_super) {
    ...
    AttributeUI.prototype.mount = function(domParent, before) {
      ...
      this._domName.setAttribute('placeholder', ContentEdit._('Имя'));
      ...
      this._domValue.setAttribute('placeholder', ContentEdit._('Значение'));
  ...
  ContentTools.TableDialog = (function(_super) {
    ...
    function TableDialog(table) {
      this.table = table;
      if (this.table) {
        TableDialog.__super__.constructor.call(this, 'Обновить таблицу');
      } else {
        TableDialog.__super__.constructor.call(this, 'Вставить таблицу');
      }
    }
    ...
    TableDialog.prototype.mount = function() {
      ...
      domHeadLabel.textContent = ContentEdit._('Шапка таблицы');
      ...
      domBodyLabel.textContent = ContentEdit._('Тело таблицы (колонки)');
      ...
      domFootLabel.textContent = ContentEdit._('Подвал таблицы');
      ...
      this._domApply = this.constructor.createDiv(['ct-control', 'ct-control--text', 'ct-control--apply']);
      this._domApply.textContent = 'Создать';
  ...
  ContentTools.VideoDialog = (function(_super) {
    ...
    function VideoDialog() {
      VideoDialog.__super__.constructor.call(this, 'Добавление видео');
    }
    ...
    VideoDialog.prototype.mount = function() {
      ...
      this._domInput.setAttribute('placeholder', ContentEdit._('Вставьте URL-адрес YouTube или Vimeo') + '...');
      this._domInput.setAttribute('type', 'text');
  ...
  ContentTools.Tools.AlignLeft = (function(_super) {
    ...
    AlignLeft.label = 'Выровнять по левому краю';
  ...
  ContentTools.Tools.AlignCenter = (function(_super) {
    ...
    AlignCenter.label = 'Выровнять по центру';
  ...
  ContentTools.Tools.AlignRight = (function(_super) {
    ...
    AlignRight.label = 'Выровнять по правому краю';
  ...
  ContentTools.Tools.UnorderedList = (function(_super) {
    ...
    UnorderedList.label = 'Маркированный список';
  ...
  ContentTools.Tools.OrderedList = (function(_super) {
    ...
    OrderedList.label = 'Список номеров';
