...
return array (
    ...
    'body' => array(
        'value' => _wp('The customer left a message from {$email} through the review form:<br /><br />{$text}'),
        'title' => _wp('Mail body'),
    ...
    'feedback' => array(
        ...
        'control_type' => waHtmlControl::CUSTOM.' '.'siteReviewPlugin::getFeedbackControl',
